...
const UserDetailModal = ({ user, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900/80 flex items-center justify-center z-50">
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-lg relative transform transition-transform duration-300 ease-in-out scale-95 hover:scale-105 hover:rotate-1">
        <button
          onClick={onClose}
        ...
        <div className="flex items-center mb-6">
          <img
            src={user.profile}
            alt="Profile"
            className="rounded-full w-24 h-24 object-cover mr-6 border-4 border-gray-700 transform transition-transform duration-300 hover:scale-110 shadow-xl"
          />
          <div>
